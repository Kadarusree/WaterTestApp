...
public class Fluoride_HelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mBackedUpLocale.getLanguage().equalsIgnoreCase("te")){
            mWebView.loadUrl("file:///android_asset/fluoride_telugu.htm");
        }
        else{
            mWebView.loadUrl("file:///android_asset/flouride.htm");
