package ramakrishna.watertest_image.fluoride;
...
public class Fluoride_TestFragment extends Fragment {
    ...
    protected void getDialogForViewPager(View v) {
        ...
        images = new int[]{R.drawable.fl_1, R.drawable.fl_2, R.drawable.fl_3,
        };

        names = new String[]{getResources().getString(R.string.f__test_step1),
                getResources().getString(R.string.f__test_step2),
                getResources().getString(R.string.f__test_step3)
        };
...
//startActivity(new Intent(getActivity(),SpeedViewAct.class));
    ...
    public void playAudio(int position){
        ...
        switch (position){
            ...
            case 0:
                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.flouride_1);
                mediaPlayer.start();
                break;
            case 1:
                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.flouride_2);
                mediaPlayer.start();
                break;
            case 2:

                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.flouride_3);
                mediaPlayer.start();
                break;
