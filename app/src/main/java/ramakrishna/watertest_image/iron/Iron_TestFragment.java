...
public class Iron_TestFragment extends Fragment {
    ...
    protected void getDialogForViewPager(View v) {
        ...
        help.setOnClickListener(new View.OnClickListener() {
          ...
          startActivity(new Intent(getActivity(), Iron_Result.class));
        ...
        images = new int[]{R.drawable.ph_1, R.drawable.iron_2, R.drawable.iron_3,R.drawable.test_done
        };

        names = new String[]{getResources().getString(R.string.iron_1),
                getResources().getString(R.string.iron_2),
                getResources().getString(R.string.iron_3),
                getResources().getString(R.string.iron_4),
        };
...
//startActivity(new Intent(getActivity(),SpeedViewAct.class));
    ...
    public void playAudio(int position){
        ...
        switch (position){
            ...
            case 0:
                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.iron_1);
                mediaPlayer.start();
                break;
            case 1:
                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.iron_2);
                mediaPlayer.start();
                break;
            case 2:

                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.iron_3);
                mediaPlayer.start();
                break;
            case 3:

                mediaPlayer= MediaPlayer.create(getActivity(),R.raw.iron_4);
                mediaPlayer.start();
                break;
