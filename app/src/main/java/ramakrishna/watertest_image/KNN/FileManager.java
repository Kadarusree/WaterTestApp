package ramakrishna.watertest_image.KNN;//FileManager
...
public class FileManager {
	...
	public static TrainRecord[] readTrainFile(String fileName) throws IOException{
		...
		System.out.println(NumOfSamples+"--"+NumOfAttributes+"--"+LabelOrNot);
	...
	public static int outputFile(TestRecord[] testRecords, String trainFilePath) throws IOException{
	...
	//	String predictPath = "classification\\"+predictName.toString()+"_prediction.txt";
		...
		//	bw.write(Integer.toString(tr.predictedLabel));
			result=tr.predictedLabel;
			System.out.println("Output : "+Integer.toString(tr.predictedLabel)+"---");
		//	bw.newLine();
		}
